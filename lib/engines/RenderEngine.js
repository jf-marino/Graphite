...
(function(module, Class, Utils, Engines) {
    ...
    var RenderEngine = Class.extend({
        ...
        canvasInContainer: function(container, width, height) {
            return this.engine.canvasInContainer(container, width, height);
        },
        ...
        path: function(fromX, fromY, toX, toY, ratio, drawPath, attr, callback) {
            return this.engine.path(fromX, fromY, toX, toY, ratio, drawPath, attr, callback);
        },
        ...
        linkVertices: function(fromX, fromY, toX, toY, radius, ratio, drawPath, attr, callback) {
            return this.engine.linkVertices(fromX, fromY, toX, toY, radius, ratio, drawPath, attr, callback);
        },
